...
export default function define (runtime, observer) {
    ...
    main.variable(observer("viewof options1")).define("viewof options1", ["form", "html"], function (form, html) {
        return (
...
stage
    ...
    main.variable(observer("options1")).define("options1", ["Generators", "viewof options1"], (G, _) => G.input(_));

    main.variable(observer("chart2")).define("chart2", ["d3", "width", "height", "FunnelChart", "data2"], function* (d3, width, height, FunnelChart, data2) {
    ...
    main.variable(observer("FunnelChart")).define("FunnelChart", ["d3"], function (d3) {
        return (
            class FunnelChart {
    ...
    main.variable(observer("data2")).define("data2", function () {
        return (
            [
                { state: "New Jersey", value: 1764545 },
                { state: "Washington", value: 4722699 },
                { state: "Neveda", value: 3276813 },
                { state: "California", value: 6925318 },
                { state: "Florida", value: 2380152 }
